...
export function DrawingCanvas({
        ...
        for (const element of selectedEquipment) {
            if (isRefrigerantPipeElementType(element.type)) {
                updateHvacElement(element.id, {
                    ...
                    properties: translateRefrigerantPipeElementProperties(element.type, element.properties, {
                        x: dxMm,
                        y: dyMm,
                    }),
                });
    ...
    const { handleMouseDown, handleMouseMove, handleMouseUp, handleWheel } = useCanvasMouseHandlers({
        ...
        handleRefrigerantPipeMouseDown, handleRefrigerantPipeMouseMove,
    ...
    useCanvasEventBinding({
        ...
        handleRefrigerantPipeDoubleClick, handleRefrigerantPipeKeyDown, handleRefrigerantPipeKeyUp,
        ...
        closeSectionLineContextMenu, closeObjectContextMenu,
        // Store actions
        setSelectedIds, setHoveredElement, setTool, setProcessingStatus,
