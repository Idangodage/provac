...
export const DEFAULT_AC_EQUIPMENT_LIBRARY: AcEquipmentDefinition[] = [
  equipment({
    ...
    supplyZoneRatio: 0.5,
    description:
      "IFC-driven indoor VRF unit based on Mitsubishi Heavy Industries FDU45KXE6F-W metadata.",
    tags: [
      "cassette",
      "ceiling",
      "indoor",
  ...
  equipment({
    ...
    supplyZoneRatio: 0.5,
    description:
      "Indoor ducted unit sized to FDUM-style compact concealed dimensions.",
