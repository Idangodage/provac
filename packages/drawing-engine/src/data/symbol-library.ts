...
const INDOOR_UNITS: SymbolDefinition[] = [
  ...
  },
  {
    ...
    defaultHeight: 0.84,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 10 10 L 90 10 L 90 90 L 10 90 Z M 50 10 L 50 90 M 10 50 L 90 50",
    connectionPoints: [
      { x: 50, y: 0 },
      { x: 100, y: 50 },
      { x: 50, y: 100 },
  ...
  },
  {
    ...
    defaultHeight: 0.6,
    svgPath:
      "M 0 0 L 100 0 L 100 50 L 0 50 Z M 10 10 L 90 10 L 90 40 L 10 40 Z M 10 25 L 90 25",
    connectionPoints: [
      { x: 0, y: 25 },
      { x: 100, y: 25 },
    ],
  },
  {
    ...
    defaultHeight: 1.8,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 20 10 L 80 10 L 80 80 L 20 80 Z M 30 85 L 70 85 L 70 95 L 30 95 Z",
  ...
  },
  {
    ...
    defaultHeight: 0.5,
    svgPath:
      "M 0 4 L 100 4 L 100 36 L 0 36 Z M 6 8 L 94 8 L 94 32 L 6 32 Z M 12 11 L 12 29 M 18 11 L 18 29 M 24 11 L 24 29 M 36 8 L 36 32 M 60 8 L 60 32 M 70 12 L 86 12 L 86 28 L 70 28 Z M 88 15 L 96 15 L 96 25 L 88 25 Z",
    connectionPoints: [
      { x: 96, y: 17 },
      { x: 96, y: 23 },
    ],
  },
  {
    ...
    defaultHeight: 0.4,
    svgPath:
      "M 0 10 L 100 10 L 100 40 L 0 40 Z M 80 0 A 20 20 0 1 1 80 1 M 10 25 L 60 25",
    connectionPoints: [
      { x: 0, y: 25 },
      { x: 100, y: 25 },
    ],
...
const OUTDOOR_UNITS: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.8,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 50 50 m -30 0 a 30 30 0 1 1 60 0 a 30 30 0 1 1 -60 0",
  ...
  },
  {
    ...
    defaultHeight: 1.2,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 25 50 m -15 0 a 15 15 0 1 1 30 0 a 15 15 0 1 1 -30 0 M 75 50 m -15 0 a 15 15 0 1 1 30 0 a 15 15 0 1 1 -30 0",
    connectionPoints: [{ x: 50, y: 100 }],
  },
  {
    id: "chiller",
    ...
    defaultHeight: 1.5,
    svgPath:
      "M 0 0 L 100 0 L 100 60 L 0 60 Z M 10 10 L 45 10 L 45 50 L 10 50 Z M 55 10 L 90 10 L 90 50 L 55 50 Z",
    connectionPoints: [
      { x: 27.5, y: 60 },
      { x: 72.5, y: 60 },
    ],
...
const DIFFUSERS: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.6,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 25 25 L 75 25 L 75 75 L 25 75 Z M 50 0 L 50 25 M 100 50 L 75 50 M 50 100 L 50 75 M 0 50 L 25 50",
  ...
  },
  {
    ...
    defaultHeight: 0.4,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 50 20 A 30 30 0 1 1 50 80 A 30 30 0 1 1 50 20",
    connectionPoints: [{ x: 50, y: 50 }],
  },
  {
    id: "diffuser-linear",
    ...
    defaultHeight: 0.15,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 10 40 L 90 40 M 10 60 L 90 60",
    connectionPoints: [{ x: 50, y: 50 }],
  },
  {
    id: "diffuser-jet",
    ...
    defaultHeight: 0.3,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 50 50 L 50 0 M 50 50 L 85 25 M 50 50 L 85 75 M 50 50 L 50 100 M 50 50 L 15 75 M 50 50 L 15 25",
    connectionPoints: [{ x: 50, y: 50 }],
  },
];
...
const GRILLES: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.3,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 10 25 L 90 25 M 10 50 L 90 50 M 10 75 L 90 75",
    connectionPoints: [{ x: 50, y: 50 }],
  },
  {
    id: "grille-return",
    ...
    defaultHeight: 0.3,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 10 20 L 90 20 L 90 80 L 10 80 Z M 20 35 L 80 35 M 20 50 L 80 50 M 20 65 L 80 65",
    connectionPoints: [{ x: 50, y: 50 }],
  },
  {
    id: "grille-transfer",
    ...
    defaultHeight: 0.2,
    svgPath:
      "M 0 0 L 100 0 L 100 100 L 0 100 Z M 20 30 L 80 30 M 20 50 L 80 50 M 20 70 L 80 70",
    connectionPoints: [],
  },
];
...
const DAMPERS: SymbolDefinition[] = [
  ...
  },
  {
    ...
    defaultHeight: 0.4,
    svgPath:
      "M 0 60 L 100 60 M 50 30 L 50 90 M 30 60 L 50 40 L 70 60 M 40 10 L 60 10 L 60 30 L 40 30 Z",
    connectionPoints: [
      { x: 0, y: 60 },
      { x: 100, y: 60 },
    ],
  },
  {
    ...
    defaultHeight: 0.3,
    svgPath:
      "M 0 50 L 100 50 M 20 30 L 80 30 L 80 70 L 20 70 Z M 35 45 L 65 45 L 65 55 L 35 55 Z",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
  },
  {
    ...
    defaultHeight: 0.3,
    svgPath:
      "M 0 50 L 100 50 M 20 30 L 80 30 L 80 70 L 20 70 Z M 30 50 L 70 50 M 50 35 L 50 65",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
...
const FANS: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.5,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 50 50 L 30 20 M 50 50 L 70 20 M 50 50 L 80 50 M 50 50 L 70 80 M 50 50 L 30 80 M 50 50 L 20 50",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
  },
  {
    ...
    defaultHeight: 0.5,
    svgPath:
      "M 0 80 L 0 20 C 0 0 30 0 50 0 A 40 40 0 1 1 50 80 L 0 80 M 100 40 L 120 40",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 120, y: 40 },
    ],
  },
  {
    ...
    defaultHeight: 0.4,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 50 50 L 50 10 M 40 20 L 50 10 L 60 20",
    connectionPoints: [{ x: 50, y: 100 }],
  },
];
...
const VALVES: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.2,
    svgPath:
      "M 0 50 L 30 30 L 30 70 Z M 70 30 L 70 70 L 100 50 Z M 30 50 L 70 50",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
  },
  {
    ...
    defaultHeight: 0.2,
    svgPath:
      "M 0 50 L 35 50 M 65 50 L 100 50 M 50 50 m -15 0 a 15 15 0 1 1 30 0 a 15 15 0 1 1 -30 0",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
  },
  {
    ...
    defaultHeight: 0.2,
    svgPath:
      "M 0 50 L 100 50 M 50 50 m -20 0 a 20 20 0 1 1 40 0 a 20 20 0 1 1 -40 0 M 45 35 L 55 50 L 45 65",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
  },
  {
    ...
    defaultHeight: 0.25,
    svgPath:
      "M 0 50 L 30 30 L 30 70 Z M 70 30 L 70 70 L 100 50 Z M 30 50 L 70 50 M 50 20 L 50 30",
    connectionPoints: [
      { x: 0, y: 50 },
      { x: 100, y: 50 },
    ],
...
const SENSORS: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.15,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 50 20 L 50 50 L 70 70",
    connectionPoints: [],
  },
  {
    id: "sensor-humidity",
    ...
    defaultHeight: 0.15,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 35 50 L 65 50 M 50 35 L 50 65",
    connectionPoints: [],
  },
  {
    id: "sensor-pressure",
    ...
    defaultHeight: 0.15,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 30 70 Q 50 20 70 70",
    connectionPoints: [],
  },
  {
    id: "sensor-co2",
    ...
    defaultHeight: 0.15,
    svgPath:
      "M 50 0 A 50 50 0 1 1 50 100 A 50 50 0 1 1 50 0 M 30 60 L 40 40 L 60 40 L 70 60",
    connectionPoints: [],
  },
];
...
const ANNOTATIONS: SymbolDefinition[] = [
  {
    ...
    defaultHeight: 0.3,
    svgPath:
      "M 10 0 L 90 0 Q 100 0 100 10 L 100 60 Q 100 70 90 70 L 30 70 L 10 90 L 20 70 L 10 70 Q 0 70 0 60 L 0 10 Q 0 0 10 0",
    connectionPoints: [],
  },
  {
    id: "section-mark",
